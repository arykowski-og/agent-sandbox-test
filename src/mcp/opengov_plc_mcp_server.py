...
@mcp.tool
async def get_records(community: str, limit: int = 100, offset: int = 0, 
                     record_type_id: Optional[str] = None, status: Optional[str] = None) -> Dict:
    """Get a list of records from the community"""
    params = {"limit": limit, "offset": offset}
    if record_type_id:
        params["recordTypeId"] = record_type_id
    if status:
        params["status"] = status
    
    return await client.make_request("GET", "/records", community, params=params)

@mcp.tool
async def get_record(community: str, record_id: str) -> Dict:
    """Get a specific record by ID"""
    return await client.make_request("GET", f"/records/{record_id}", community)

@mcp.tool
async def create_record(community: str, record_data: Dict) -> Dict:
    """Create a new record"""
    return await client.make_request("POST", "/records", community, json_data=record_data)

@mcp.tool
async def update_record(community: str, record_id: str, record_data: Dict) -> Dict:
    """Update an existing record"""
    return await client.make_request("PUT", f"/records/{record_id}", community, json_data=record_data)

@mcp.tool
async def delete_record(community: str, record_id: str) -> Dict:
    """Delete a record"""
    return await client.make_request("DELETE", f"/records/{record_id}", community)
...
async def get_record_attachments(community: str, record_id: str) -> Dict:
    ...
    return await client.make_request("GET", f"/records/{record_id}/attachments", community)

@mcp.tool
async def get_record_attachment(community: str, record_id: str, attachment_id: str) -> Dict:
    """Get a specific record attachment"""
    return await client.make_request("GET", f"/records/{record_id}/attachments/{attachment_id}", community)

@mcp.tool
async def create_record_attachment(community: str, record_id: str, attachment_data: Dict) -> Dict:
    """Create a new record attachment"""
    return await client.make_request("POST", f"/records/{record_id}/attachments", community, json_data=attachment_data)
...
async def update_record_attachment(community: str, record_id: str, attachment_id: str, attachment_data: Dict) -> Dict:
    ...
    return await client.make_request("PUT", f"/records/{record_id}/attachments/{attachment_id}", community, json_data=attachment_data)

@mcp.tool
async def delete_record_attachment(community: str, record_id: str, attachment_id: str) -> Dict:
    """Delete a record attachment"""
    return await client.make_request("DELETE", f"/records/{record_id}/attachments/{attachment_id}", community)
...
async def get_record_workflow_steps(community: str, record_id: str) -> Dict:
    ...
    return await client.make_request("GET", f"/records/{record_id}/workflowSteps", community)

@mcp.tool
async def get_record_workflow_step(community: str, record_id: str, step_id: str) -> Dict:
    """Get a specific workflow step"""
    return await client.make_request("GET", f"/records/{record_id}/workflowSteps/{step_id}", community)

@mcp.tool
async def update_record_workflow_step(community: str, record_id: str, step_id: str, step_data: Dict) -> Dict:
    """Update a workflow step"""
    return await client.make_request("PUT", f"/records/{record_id}/workflowSteps/{step_id}", community, json_data=step_data)
...
async def get_record_step_comments(community: str, record_id: str, step_id: str) -> Dict:
    ...
    return await client.make_request("GET", f"/records/{record_id}/workflowSteps/{step_id}/comments", community)
...
async def create_record_step_comment(community: str, record_id: str, step_id: str, comment_data: Dict) -> Dict:
    ...
    return await client.make_request("POST", f"/records/{record_id}/workflowSteps/{step_id}/comments", community, json_data=comment_data)
...
async def delete_record_step_comment(community: str, record_id: str, step_id: str, comment_id: str) -> Dict:
    ...
    return await client.make_request("DELETE", f"/records/{record_id}/workflowSteps/{step_id}/comments/{comment_id}", community)
...
async def get_record_form_details(community: str, record_id: str) -> Dict:
    ...
    return await client.make_request("GET", f"/records/{record_id}/details", community)

@mcp.tool
async def get_record_form_field(community: str, record_id: str, form_field_id: str) -> Dict:
    """Get a specific form field"""
    return await client.make_request("GET", f"/records/{record_id}/details/{form_field_id}", community)

@mcp.tool
async def update_record_form_field(community: str, record_id: str, form_field_id: str, field_data: Dict) -> Dict:
    """Update a form field"""
    return await client.make_request("PUT", f"/records/{record_id}/details/{form_field_id}", community, json_data=field_data)
...
async def get_record_primary_location(community: str, record_id: str) -> Dict:
    ...
    return await client.make_request("GET", f"/records/{record_id}/primaryLocation", community)
...
async def update_record_primary_location(community: str, record_id: str, location_data: Dict) -> Dict:
    ...
    return await client.make_request("PUT", f"/records/{record_id}/primaryLocation", community, json_data=location_data)

@mcp.tool
async def get_record_additional_locations(community: str, record_id: str) -> Dict:
    """Get additional locations for a record"""
    return await client.make_request("GET", f"/records/{record_id}/additionalLocations", community)
...
async def add_record_additional_location(community: str, record_id: str, location_data: Dict) -> Dict:
    ...
    return await client.make_request("POST", f"/records/{record_id}/additionalLocations", community, json_data=location_data)
...
async def remove_record_additional_location(community: str, record_id: str, location_id: str) -> Dict:
    ...
    return await client.make_request("DELETE", f"/records/{record_id}/additionalLocations/{location_id}", community)
...
async def get_record_applicant(community: str, record_id: str) -> Dict:
    ...
    return await client.make_request("GET", f"/records/{record_id}/applicant", community)

@mcp.tool
async def get_record_guests(community: str, record_id: str) -> Dict:
    """Get guests for a record"""
    return await client.make_request("GET", f"/records/{record_id}/guests", community)

@mcp.tool
async def add_record_guest(community: str, record_id: str, guest_data: Dict) -> Dict:
    """Add a guest to a record"""
    return await client.make_request("POST", f"/records/{record_id}/guests", community, json_data=guest_data)

@mcp.tool
async def remove_record_guest(community: str, record_id: str, user_id: str) -> Dict:
    """Remove a guest from a record"""
    return await client.make_request("DELETE", f"/records/{record_id}/guests/{user_id}", community)
...
async def get_record_change_requests(community: str, record_id: str) -> Dict:
    ...
    return await client.make_request("GET", f"/records/{record_id}/changeRequests", community)
...
async def create_record_change_request(community: str, record_id: str, change_request_data: Dict) -> Dict:
    ...
    return await client.make_request("POST", f"/records/{record_id}/changeRequests", community, json_data=change_request_data)

@mcp.tool
async def get_record_change_request(community: str, record_id: str, change_request_id: str) -> Dict:
    """Get a specific change request"""
    return await client.make_request("GET", f"/records/{record_id}/changeRequests/{change_request_id}", community)

# LOCATIONS

@mcp.tool
async def get_locations(community: str, limit: int = 100, offset: int = 0) -> Dict:
    """Get a list of locations"""
    params = {"limit": limit, "offset": offset}
    return await client.make_request("GET", "/locations", community, params=params)

@mcp.tool
async def get_location(community: str, location_id: str) -> Dict:
    """Get a specific location by ID"""
    return await client.make_request("GET", f"/locations/{location_id}", community)

@mcp.tool
async def create_location(community: str, location_data: Dict) -> Dict:
    """Create a new location"""
    return await client.make_request("POST", "/locations", community, json_data=location_data)

@mcp.tool
async def update_location(community: str, location_id: str, location_data: Dict) -> Dict:
    """Update a location"""
    return await client.make_request("PUT", f"/locations/{location_id}", community, json_data=location_data)

@mcp.tool
async def get_location_flags(community: str, location_id: str) -> Dict:
    """Get flags for a location"""
    return await client.make_request("GET", f"/locations/{location_id}/flags", community)

# USERS

@mcp.tool
async def get_users(community: str, limit: int = 100, offset: int = 0, search: Optional[str] = None) -> Dict:
    """Get a list of users"""
    params = {"limit": limit, "offset": offset}
    if search:
        params["search"] = search
    return await client.make_request("GET", "/users", community, params=params)

@mcp.tool
async def get_user(community: str, user_id: str) -> Dict:
    """Get a specific user by ID"""
    return await client.make_request("GET", f"/users/{user_id}", community)

@mcp.tool
async def create_user(community: str, user_data: Dict) -> Dict:
    """Create a new user"""
    return await client.make_request("POST", "/users", community, json_data=user_data)

@mcp.tool
async def update_user(community: str, user_id: str, user_data: Dict) -> Dict:
    """Update a user"""
    return await client.make_request("PUT", f"/users/{user_id}", community, json_data=user_data)

@mcp.tool
async def get_user_flags(community: str, user_id: str) -> Dict:
    """Get flags for a user"""
    return await client.make_request("GET", f"/users/{user_id}/flags", community)
...
async def get_departments(community: str) -> Dict:
    ...
    return await client.make_request("GET", "/departments", community)

@mcp.tool
async def get_department(community: str, department_id: str) -> Dict:
    """Get a specific department by ID"""
    return await client.make_request("GET", f"/departments/{department_id}", community)
...
async def get_record_type_attachments(community: str, record_type_id: str) -> Dict:
    ...
    return await client.make_request("GET", f"/recordTypes/{record_type_id}/attachments", community)

@mcp.tool
async def get_record_type_fees(community: str, record_type_id: str) -> Dict:
    """Get fee configurations for a record type"""
    return await client.make_request("GET", f"/recordTypes/{record_type_id}/fees", community)
...
async def get_record_type_document_templates(community: str, record_type_id: str) -> Dict:
    ...
    return await client.make_request("GET", f"/recordTypes/{record_type_id}/documentTemplates", community)

# PROJECTS

@mcp.tool
async def get_projects(community: str, limit: int = 100, offset: int = 0) -> Dict:
    """Get a list of projects"""
    params = {"limit": limit, "offset": offset}
    return await client.make_request("GET", "/projects", community, params=params)
...
async def get_inspection_steps(community: str, limit: int = 100, offset: int = 0) -> Dict:
    ...
    params = {"limit": limit, "offset": offset}
    return await client.make_request("GET", "/inspectionSteps", community, params=params)

@mcp.tool
async def get_inspection_step(community: str, inspection_step_id: str) -> Dict:
    """Get a specific inspection step"""
    return await client.make_request("GET", f"/inspectionSteps/{inspection_step_id}", community)

@mcp.tool
async def update_inspection_step(community: str, inspection_step_id: str, step_data: Dict) -> Dict:
    """Update an inspection step"""
    return await client.make_request("PUT", f"/inspectionSteps/{inspection_step_id}", community, json_data=step_data)

@mcp.tool
async def get_inspection_step_types(community: str, inspection_step_id: str) -> Dict:
    """Get inspection types for an inspection step"""
    return await client.make_request("GET", f"/inspectionSteps/{inspection_step_id}/inspectionTypes", community)
...
async def get_inspection_events(community: str, limit: int = 100, offset: int = 0) -> Dict:
    ...
    params = {"limit": limit, "offset": offset}
    return await client.make_request("GET", "/inspectionEvents", community, params=params)

@mcp.tool
async def get_inspection_event(community: str, inspection_event_id: str) -> Dict:
    """Get a specific inspection event"""
    return await client.make_request("GET", f"/inspectionEvents/{inspection_event_id}", community)

@mcp.tool
async def create_inspection_event(community: str, event_data: Dict) -> Dict:
    """Create an inspection event"""
    return await client.make_request("POST", "/inspectionEvents", community, json_data=event_data)

@mcp.tool
async def update_inspection_event(community: str, inspection_event_id: str, event_data: Dict) -> Dict:
    """Update an inspection event"""
    return await client.make_request("PUT", f"/inspectionEvents/{inspection_event_id}", community, json_data=event_data)
...
async def get_inspection_results(community: str, limit: int = 100, offset: int = 0) -> Dict:
    ...
    params = {"limit": limit, "offset": offset}
    return await client.make_request("GET", "/inspectionResults", community, params=params)

@mcp.tool
async def get_inspection_result(community: str, inspection_result_id: str) -> Dict:
    """Get a specific inspection result"""
    return await client.make_request("GET", f"/inspectionResults/{inspection_result_id}", community)

@mcp.tool
async def create_inspection_result(community: str, result_data: Dict) -> Dict:
    """Create an inspection result"""
    return await client.make_request("POST", "/inspectionResults", community, json_data=result_data)
...
async def update_inspection_result(community: str, inspection_result_id: str, result_data: Dict) -> Dict:
    ...
    return await client.make_request("PUT", f"/inspectionResults/{inspection_result_id}", community, json_data=result_data)
...
async def get_checklist_results(community: str, inspection_result_id: str) -> Dict:
    ...
    return await client.make_request("GET", f"/inspectionResults/{inspection_result_id}/checklistResults", community)
...
async def get_checklist_result(community: str, inspection_result_id: str, checklist_result_id: str) -> Dict:
    ...
    return await client.make_request("GET", f"/inspectionResults/{inspection_result_id}/checklistResults/{checklist_result_id}", community)
...
async def create_checklist_result(community: str, inspection_result_id: str, checklist_data: Dict) -> Dict:
    ...
    return await client.make_request("POST", f"/inspectionResults/{inspection_result_id}/checklistResults", community, json_data=checklist_data)
...
async def update_checklist_result(community: str, inspection_result_id: str, checklist_result_id: str, checklist_data: Dict) -> Dict:
    ...
    return await client.make_request("PUT", f"/inspectionResults/{inspection_result_id}/checklistResults/{checklist_result_id}", community, json_data=checklist_data)
...
async def get_inspection_type_templates(community: str) -> Dict:
    ...
    return await client.make_request("GET", "/inspectionTypeTemplates", community)

@mcp.tool
async def get_inspection_type_template(community: str, template_id: str) -> Dict:
    """Get a specific inspection type template"""
    return await client.make_request("GET", f"/inspectionTypeTemplates/{template_id}", community)
...
async def get_checklist_templates(community: str, template_id: str) -> Dict:
    ...
    return await client.make_request("GET", f"/inspectionTypeTemplates/{template_id}/checklistTemplates", community)
...
async def get_checklist_template(community: str, template_id: str, checklist_template_id: str) -> Dict:
    ...
    return await client.make_request("GET", f"/inspectionTypeTemplates/{template_id}/checklistTemplates/{checklist_template_id}", community)
...
async def get_approval_steps(community: str, limit: int = 100, offset: int = 0) -> Dict:
    """Get approval steps"""
    params = {"limit": limit, "offset": offset}
    return await client.make_request("GET", "/approvalSteps", community, params=params)

@mcp.tool
async def get_approval_step(community: str, approval_step_id: str) -> Dict:
    """Get a specific approval step"""
    return await client.make_request("GET", f"/approvalSteps/{approval_step_id}", community)

@mcp.tool
async def update_approval_step(community: str, approval_step_id: str, step_data: Dict) -> Dict:
    """Update an approval step"""
    return await client.make_request("PUT", f"/approvalSteps/{approval_step_id}", community, json_data=step_data)
...
async def get_document_steps(community: str, limit: int = 100, offset: int = 0) -> Dict:
    ...
    params = {"limit": limit, "offset": offset}
    return await client.make_request("GET", "/documentSteps", community, params=params)

@mcp.tool
async def get_document_step(community: str, document_step_id: str) -> Dict:
    """Get a specific document generation step"""
    return await client.make_request("GET", f"/documentSteps/{document_step_id}", community)

@mcp.tool
async def update_document_step(community: str, document_step_id: str, step_data: Dict) -> Dict:
    """Update a document generation step"""
    return await client.make_request("PUT", f"/documentSteps/{document_step_id}", community, json_data=step_data)
...
async def get_payment_steps(community: str, limit: int = 100, offset: int = 0) -> Dict:
    """Get payment steps"""
    params = {"limit": limit, "offset": offset}
    return await client.make_request("GET", "/paymentSteps", community, params=params)

@mcp.tool
async def get_payment_step(community: str, payment_step_id: str) -> Dict:
    """Get a specific payment step"""
    return await client.make_request("GET", f"/paymentSteps/{payment_step_id}", community)

@mcp.tool
async def update_payment_step(community: str, payment_step_id: str, step_data: Dict) -> Dict:
    """Update a payment step"""
    return await client.make_request("PUT", f"/paymentSteps/{payment_step_id}", community, json_data=step_data)

@mcp.tool
async def get_payment_fees(community: str, payment_step_id: str) -> Dict:
    """Get fees for a payment step"""
    return await client.make_request("GET", f"/paymentSteps/{payment_step_id}/fees", community)

@mcp.tool
async def get_payment_fee(community: str, payment_fee_id: str) -> Dict:
    """Get a specific payment fee"""
    return await client.make_request("GET", f"/paymentSteps/fees/{payment_fee_id}", community)
...
async def get_transactions(community: str, limit: int = 100, offset: int = 0) -> Dict:
    ...
    params = {"limit": limit, "offset": offset}
    return await client.make_request("GET", "/transactions", community, params=params)

@mcp.tool
async def get_transaction(community: str, transaction_id: str) -> Dict:
    """Get a specific transaction"""
    return await client.make_request("GET", f"/transactions/{transaction_id}", community)
...
async def get_ledger_entries(community: str, limit: int = 100, offset: int = 0) -> Dict:
    """Get ledger entries"""
    params = {"limit": limit, "offset": offset}
    return await client.make_request("GET", "/ledgerEntries", community, params=params)

@mcp.tool
async def get_ledger_entry(community: str, ledger_id: str) -> Dict:
    """Get a specific ledger entry"""
    return await client.make_request("GET", f"/ledgerEntries/{ledger_id}", community)
...
async def get_files(community: str, limit: int = 100, offset: int = 0) -> Dict:
    """Get files"""
    params = {"limit": limit, "offset": offset}
    return await client.make_request("GET", "/files", community, params=params)

@mcp.tool
async def get_file(community: str, file_id: str) -> Dict:
    """Get a specific file"""
    return await client.make_request("GET", f"/files/{file_id}", community)

@mcp.tool
async def create_file(community: str, file_data: Dict) -> Dict:
    """Create a file entry for upload"""
    return await client.make_request("POST", "/files", community, json_data=file_data)

@mcp.tool
async def update_file(community: str, file_id: str, file_data: Dict) -> Dict:
    """Update file metadata"""
    return await client.make_request("PUT", f"/files/{file_id}", community, json_data=file_data)

@mcp.tool
async def delete_file(community: str, file_id: str) -> Dict:
    """Delete a file"""
    return await client.make_request("DELETE", f"/files/{file_id}", community)
...
async def get_organization(community: str) -> Dict:
    ...
    return await client.make_request("GET", "/organization", community)
